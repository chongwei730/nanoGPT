...
#SBATCH --array=0-9
#SBATCH --output=/users/9/chen8596/nanoGPT/exp_log/llama350m_sens_ls_adam_%A_%a.out
#SBATCH --error=/users/9/chen8596/nanoGPT/exp_log/llama350m_sens_ls_adam_%A_%a.err
