#!/bin/bash
#SBATCH --job-name=sens_ls_adam_llama350m
#SBATCH --time=9:00:00
#SBATCH --ntasks=1
...
#SBATCH --array=0-9
#SBATCH --output=/scratch.global/zhan9381/nanoGPT/exp_log/llama_350m_sensitivity_linesearch_adam_c1_%A_%a.out
#SBATCH --error=/scratch.global/zhan9381/nanoGPT/exp_log/llama_350m_sensitivity_linesearch_adam_c1_%A_%a.err
