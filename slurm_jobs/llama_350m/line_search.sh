...
#SBATCH --output=/users/9/chen8596/nanoGPT/exp_log/llama350m_linesearch_%A_%a.out
#SBATCH --error=/users/9/chen8596/nanoGPT/exp_log/llama350m_linesearch_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs/llama350m_line_search_stage2_maxiters_${MAX_ITERS}"
