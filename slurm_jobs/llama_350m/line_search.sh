...
#SBATCH --output=/scratch.global/zhan9381/nanoGPT/exp_log/llama_350m_line_search_%A_%a.out
#SBATCH --error=/scratch.global/zhan9381/nanoGPT/exp_log/llama_350m_line_search_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs_modified/llama350m_line_search_stage2_maxiters_${MAX_ITERS}"
...
python run_linesearch_stage2.py \
  ...
  --nproc-per-node 4 \
  --experiment-name "llama350m_line_search" \
