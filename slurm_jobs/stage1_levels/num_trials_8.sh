...
#SBATCH --output=exp_log/small_n8_%A_%a.out
#SBATCH --error=exp_log/small_n8_%A_%a.err
...
RUN_ROOT="experiment_runs/gpt124m_lr_search_serial_halving_num_trials_8"
