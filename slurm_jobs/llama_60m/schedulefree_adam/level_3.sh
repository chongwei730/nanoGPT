#!/bin/bash
#SBATCH --job-name=l3_llama60_sfa
...
#SBATCH --output=/scratch.global/zhan9381/nanoGPT/exp_log/llama_60m_schedulefree_adam_level_3_%A_%a.out
#SBATCH --error=/scratch.global/zhan9381/nanoGPT/exp_log/llama_60m_schedulefree_adam_level_3_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs_lasthedulefree_adam_lr_search_tuning_batch_level_3_maxiters_${MAX_ITERS}"
