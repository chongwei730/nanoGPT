#!/bin/bash
#SBATCH --job-name=n4_llama60_sfa
...
#SBATCH --output=/scratch.global/zhan9381/nanoGPT/exp_log/llama_60m_schedulefree_adam_num_trials_4_%A_%a.out
#SBATCH --error=/scratch.global/zhan9381/nanoGPT/exp_log/llama_60m_schedulefree_adam_num_trials_4_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs_modified/llama60m_schedulefree_adam_lr_search_serial_halving_num_trials_4_maxiters_${MAX_ITERS}"
