...
#SBATCH --array=0-9
#SBATCH --output=/users/9/chen8596/nanoGPT/exp_log/llama60m_sens_ls_muon_%A_%a.out
#SBATCH --error=/users/9/chen8596/nanoGPT/exp_log/llama60m_sens_ls_muon_%A_%a.err
