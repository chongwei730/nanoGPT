#!/bin/bash
#SBATCH --job-name=l1_llama1b_sfa
...
#SBATCH --output=/scratch.global/zhan9381/nanoGPT/exp_log/llama_1b_schedulefree_adam_level_1_%A_%a.out
#SBATCH --error=/scratch.global/zhan9381/nanoGPT/exp_log/llama_1b_schedulefree_adam_level_1_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs_last/llama1b_schedulefree_adam_lr_search_tuning_batch_level_1_maxiters_${MAX_ITERS}"
