...
#SBATCH --output=/scratch.global/zhan9381/nanoGPT/exp_log/gpt2_355m_cosine_level_1_%A_%a.out
#SBATCH --error=/scratch.global/zhan9381/nanoGPT/exp_log/gpt2_355m_cosine_level_1_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs_last355m_lr_search_tuning_batch_level_1_maxiters_${MAX_ITERS}"
