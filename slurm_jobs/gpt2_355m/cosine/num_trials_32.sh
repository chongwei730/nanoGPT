...
#SBATCH --output=/users/9/chen8596/nanoGPT/exp_log/gpt355m_cosine_n32_%A_%a.out
#SBATCH --error=/users/9/chen8596/nanoGPT/exp_log/gpt355m_cosine_n32_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs/gpt355m_lr_search_serial_halving_num_trials_32_maxiters_${MAX_ITERS}"
