...
#SBATCH --output=/scratch.global/zhan9381/nanoGPT/exp_log/gpt2_355m_cosine_num_trials_8_%A_%a.out
#SBATCH --error=/scratch.global/zhan9381/nanoGPT/exp_log/gpt2_355m_cosine_num_trials_8_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs_modified/gpt355m_lr_search_serial_halving_num_trials_8_maxiters_${MAX_ITERS}"
