...
#SBATCH --output=/users/9/chen8596/nanoGPT/exp_log/gpt770m_sfa_n8_%A_%a.out
#SBATCH --error=/users/9/chen8596/nanoGPT/exp_log/gpt770m_sfa_n8_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs/gpt770m_schedulefree_adam_lr_search_serial_halving_num_trials_8_maxiters_${MAX_ITERS}"
