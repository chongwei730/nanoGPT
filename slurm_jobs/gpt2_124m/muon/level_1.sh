#!/bin/bash
#SBATCH --job-name=l1_gpt124_muon
...
#SBATCH --output=/scratch.global/zhan9381/nanoGPT/exp_log/gpt2_124m_muon_level_1_%A_%a.out
#SBATCH --error=/scratch.global/zhan9381/nanoGPT/exp_log/gpt2_124m_muon_level_1_%A_%a.err
