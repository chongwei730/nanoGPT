...
#SBATCH --gres=gpu:4 
#SBATCH -p gpuA100x4
#SBATCH --output=exp_log/gpt124m_sfa_n12_%A_%a.out
#SBATCH --error=exp_log/gpt124m_sfa_n12_%A_%a.err
...
RUN_ROOT="/work/nvme/bgop/cchen47/gpt124m_schedulefree_adam_lr_search_serial_halving_num_trials_12"
