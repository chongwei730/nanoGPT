...
#SBATCH --output=/users/9/chen8596/nanoGPT/exp_log/gpt124m_sfa_n12_%A_%a.out
#SBATCH --error=/users/9/chen8596/nanoGPT/exp_log/gpt124m_sfa_n12_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs/gpt124m_schedulefree_adam_lr_search_serial_halving_num_trials_12_maxiters_${MAX_ITERS}"
