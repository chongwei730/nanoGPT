...
#SBATCH --output=exp_log/gpt124m_sfa_n16_%A_%a.out
#SBATCH --error=exp_log/gpt124m_sfa_n16_%A_%a.err
...
RUN_ROOT="experiment_runs/gpt124m_schedulefree_adam_lr_search_serial_halving_num_trials_16"
