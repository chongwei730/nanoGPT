...
#SBATCH --array=0-9
#SBATCH --output=/scratch.global/zhan9381/nanoGPT/exp_log/gpt2_124m_sensitivity_linesearch_adam_c1_%A_%a.out
#SBATCH --error=/scratch.global/zhan9381/nanoGPT/exp_log/gpt2_124m_sensitivity_linesearch_adam_c1_%A_%a.err
