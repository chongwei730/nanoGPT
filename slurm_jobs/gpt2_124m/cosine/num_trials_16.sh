#!/bin/bash
#SBATCH --job-name=n16_gpt124_cos
...
#SBATCH --output=/scratch.global/zhan9381/nanoGPT/exp_log/gpt2_124m_cosine_num_trials_16_%A_%a.out
#SBATCH --error=/scratch.global/zhan9381/nanoGPT/exp_log/gpt2_124m_cosine_num_trials_16_%A_%a.err
...
RUN_ROOT="/scratch.global/chen8596/experiment_runs_modified/gpt124m_lr_search_serial_halving_num_trials_16_maxiters_${MAX_ITERS}"
