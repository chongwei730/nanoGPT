#!/bin/bash
#SBATCH --job-name=n16_gpt124_cos_smk
...
#SBATCH --gres=gpu:4
#SBATCH -p gpuA100x4
#SBATCH --output=exp_log/gpt124m_cosine_n16_smoke_%A_%a.out
#SBATCH --error=exp_log/gpt124m_cosine_n16_smoke_%A_%a.err
...
RUN_ROOT="/work/nvme/bgop/cchen47/experiment_runs/gpt124m_lr_search_serial_halving_num_trials_16_smoke_ei${SMOKE_EVAL_INTERVAL}"
