"""
Train a LLaMA model with magnitude line-search learning rate adaptation for
stage2 runs using streaming C4 data.
"""
...
def write_experiment_summary(termination_reason, forward_backward_hours, wall_clock_hours):
    ...
    summary = {
        ...
        "trial_id": trial_id,
        "train_script": "train_linesearch_llama_mag_stream.py",
        "out_dir": out_dir,
